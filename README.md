...
- **Memoria JVM:** Kubernetes limita cada pod a `512Mi` y configura el heap máximo al 60%, dejando margen para metaspace, threads y memoria nativa; esto evita que el kernel termine el proceso por exceder el límite del contenedor.
